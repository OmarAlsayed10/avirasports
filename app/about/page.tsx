...
export default function AboutPage() {
  ...
  const TRUST_ITEMS = [
    ...
    { title: t.about.deliveryTitle, description: t.about.deliverySub },
      ...
      <section>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {TRUST_ITEMS.map((item) => (
            ...
            >
              <h3 className="text-base font-semibold text-text-primary dark:text-text-on-dark">{item.title}</h3>
