...
import { featuredProductsTokens } from "./featured-products.tokens";
...
export async function FeaturedProducts() {
  ...
  return (
    <section className={featuredProductsTokens.base} aria-label="Featured products">
      <div className={featuredProductsTokens.inner}>
        <div className={featuredProductsTokens.header}>
          <h2 className={featuredProductsTokens.heading}>{t.admin.typeFeatured}</h2>
          <Link href="/shop?sort=featured" className={featuredProductsTokens.viewAllLink}>
            {t.home.viewAll} <ArrowRight className="w-4 h-4" />
          </Link>
        </div>

        <div className={featuredProductsTokens.grid}>
