...
import { quantityOfferPopupTokens } from './quantity-offer-popup.tokens';
import type { QuantityOfferPopupProps } from './quantity-offer-popup.types';
...
export function QuantityOfferPopup({
  ...
  const p = quantityOfferPopupTokens;
